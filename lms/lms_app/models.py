...
class Book(models.Model):
    ...
    rent_price_day = models.DecimalField(max_digits=5,decimal_places=2,null=True,blank=True)
    rent_period = models.IntegerField(null=True,blank=True)
    rent_total_price = models.DecimalField(max_digits=5,decimal_places=2,null=True,blank=True)
